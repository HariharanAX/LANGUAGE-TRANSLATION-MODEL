...
with open(r"C:\genai\genai\translater\eng_tokenizer.pkl", 'rb') as f:
    eng_tok = pickle.load(f)
with open(r"C:\genai\genai\translater\fr_tokenizer.pkl", 'rb') as f:
    fr_tok = pickle.load(f)

# Load the encoder and decoder models
gen_encoder = load_model(r"C:\genai\genai\translater\encoder_model.h5")
gen_decoder = load_model(r"C:\genai\genai\translater\decoder_model.h5")


# Define your Flask app
app = Flask(__name__)

# Define contractions and English stopwords
...
# Function to generate translation from encoder input
def generate_from_encoder_input(encoder_input):
    ...
    generated_sequence = []
    for count in range(fr_sequence_size):
...
def index():
    ...
    if request.method == 'POST':
        ...
        if user_input:
            translation_result = translate_user_input(user_input)
